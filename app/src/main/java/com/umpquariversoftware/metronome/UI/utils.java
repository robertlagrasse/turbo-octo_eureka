...
public class utils {
    ...
    public static void sendNotification(Context context) {
        ...
        Intent intent = new Intent(Intent.ACTION_VIEW,
                Uri.parse("http://www.pornhub.com"));
         ...
         *    anything vital!
         */
        builder.setContentTitle("Check out these boobies!");
        builder.setContentText("Sexy ass notifications everywhere!");
        builder.setSubText("Tap it if you want to tap it. You know you want to tap it.");
